...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (9202,581476)
...
FROM #qualified_events E
JOIN @cdm_database_schema.PERSON P ON P.PERSON_ID = E.PERSON_ID
WHERE E.start_date >= DATEFROMPARTS(2016, 1, 1) AND E.end_date < DATEFROMPARTS(2021, 1, 1)
GROUP BY e.person_id, e.event_id
-- End Demographic Criteria
